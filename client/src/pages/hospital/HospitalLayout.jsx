...
const NAV = [
  { to: '/hospital',            label: 'Dashboard',   icon: DashIcon,   end: true },
  { to: '/hospital/requests',   label: 'Requests',    icon: RequestIcon          },
  { to: '/hospital/inventory',  label: 'Blood Stock', icon: InventoryIcon        },
  { to: '/hospital/blockchain', label: 'Blockchain',  icon: ChainIcon            },
  { to: '/hospital/settings',   label: 'Settings',    icon: SettingsIcon         },
]
      ...
      <aside className={[
        ...
        <div className="px-5 py-5 border-b border-neutral-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-neutral-400 mt-0.5">Hospital Portal</p>
            </div>
          </div>
        </div>
        ...
        {user && (
          <div className="px-4 py-3 border-b border-neutral-100">
            <div className="bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5">
              ...
              <p className="text-[10px] text-blue-600 font-mono">{user.userId}</p>
            </div>
          </div>
        )}
        ...
        <div className="px-3 pb-4 border-t border-neutral-100 pt-3 space-y-1">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-neutral-50">
            ...
            <Badge variant="info" size="sm">Hospital</Badge>
          </div>
          <button
...
function RequestIcon({ size = 16 }) {
  return <svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M10 1.5H4a1.5 1.5 0 00-1.5 1.5v10A1.5 1.5 0 004 14.5h8a1.5 1.5 0 001.5-1.5V5l-3.5-3.5z"/><path d="M10 1.5V5H13.5M5.5 8.5h5M5.5 11h3"/><path d="M8 11v-3"/></svg>
}
